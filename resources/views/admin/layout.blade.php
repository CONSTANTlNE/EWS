...
<head>
    ...
    {{--    <!-- Favicon -->--}}
    {{--    <link rel="shortcut icon" href="../adminAssets/images/brand-logos/favicon.ico"/>--}}
    ...
    <!-- Simplebar Css -->
    <link rel="stylesheet" href="{{asset('adminAssets/libs/simplebar/simplebar.min.css')}}"/>

    <!-- Color Picker Css -->
    <link
            rel="stylesheet"
            href="{{asset('adminAssets/libs/@simonwep/pickr/themes/nano.min.css')}}"
    />

    <!-- Datatable Css -->
    <link rel="stylesheet" href="https://cdn.datatables.net/2.0.0/css/dataTables.dataTables.css">
    <!-- Tom Select Css -->
    {{--    <link rel="stylesheet" href="{{asset('adminAssets/libs/tom-select/css/tom-select.default.min.css')}}">--}}
    <!-- Quill Editor -->
...
<!-- Loader -->
<div id="loader">
    {{--    <img src="../adminAssets/images/media/loader.svg" alt=""/>--}}
</div>
<!-- Loader -->
<div class="page">
    <!-- Start::Header -->
...
<!-- Tom Select JS -->
{{--<script src="{{asset('adminAssets/libs/tom-select/js/tom-select.complete.min.js')}}"></script>--}}
{{--<script src="{{asset('adminAssets/js/tom-select.js')}}"></script>--}}
<!-- Language Switch -->
...
<script>
    ...
    document
        ...
        .addEventListener("click", function () {
            ...
            var template = document.getElementById("featruresTemplate");
            ...
            document.getElementById("featuresdiv").appendChild(clonedTemplate);
    ...
    // Delegate the event
    document.getElementById("featuresdiv").addEventListener("click", function (e) {
    ...
    document.getElementById("oldfeatures").addEventListener("click", function (e) {
        if (e.target.className === "removeButton") {
            // Remove the parent node (the paragraph)
            e.target.parentNode.remove();
        }
