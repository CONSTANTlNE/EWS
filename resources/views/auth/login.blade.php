...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('adminAssets/images/site-logo.svg')}}">
    ...
    <!-- Simplebar Css -->
    <link id="style" href="{{asset('adminAssets/libs/simplebar/simplebar.min.css" rel="stylesheet')}}">

    <!-- Swiper Css -->
    <link rel="stylesheet" href="{{asset('adminAssets/libs/swiper/swiper-bundle.min.css')}}">
...
<!-- Show Password JS -->
<script src="{{asset('adminAssets/js/show-password.js')}}"></script>

<!-- Auth Custom JS -->
<script src="{{asset('adminAssets/js/auth-custom.js')}}"></script>
